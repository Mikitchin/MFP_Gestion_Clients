...
return [
    ...
    [ // $staticRoutes
        ...
        '/cs_demandes' => [[['_route' => 'app_csdem', '_controller' => 'App\\Controller\\CsController::lstdem'], null, null, null, false, false, null]],
        '/cs_traitement' => [[['_route' => 'app_cstreat', '_controller' => 'App\\Controller\\CsController::listtreat'], null, null, null, false, false, null]],
        '/cs_statistiques' => [[['_route' => 'app_statsrdvcs', '_controller' => 'App\\Controller\\CsController::statsrdvsup'], null, null, null, false, false, null]],
        '/cs_inforecep' => [[['_route' => 'app_csinforecep', '_controller' => 'App\\Controller\\CsController::inforecep'], null, null, null, false, false, null]],
        ...
        '/gestionnaire_demandes' => [[['_route' => 'app_ges_dem', '_controller' => 'App\\Controller\\GsController::ges_dem'], null, null, null, false, false, null]],
        '/gestionnaire_traitement' => [[['_route' => 'app_ges_treat', '_controller' => 'App\\Controller\\GsController::ges_treat'], null, null, null, false, false, null]],
        '/rdv_gestionnaire' => [[['_route' => 'app_rdv_gest', '_controller' => 'App\\Controller\\GsController::rdv_gest'], null, null, null, false, false, null]],
        '/list_demande_gestionnaire' => [[['_route' => 'app_lst_dem_gest', '_controller' => 'App\\Controller\\GsController::lst_dem_gest'], null, null, null, false, false, null]],
        ...
        '/superviseur_demandes' => [[['_route' => 'app_lstdem', '_controller' => 'App\\Controller\\SuperviseurController::lstdem'], null, null, null, false, false, null]],
        '/superviseur_traitement' => [[['_route' => 'app_listtreat', '_controller' => 'App\\Controller\\SuperviseurController::listtreat'], null, null, null, false, false, null]],
        '/superviseur_statistiques' => [[['_route' => 'app_statsrdvsup', '_controller' => 'App\\Controller\\SuperviseurController::statsrdvsup'], null, null, null, false, false, null]],
        '/superviseur_inforecep' => [[['_route' => 'app_inforecep', '_controller' => 'App\\Controller\\SuperviseurController::inforecep'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        186 => [
            [['_route' => 'app_demande_rdv', '_controller' => 'App\\Controller\\DemandeRdvController::index'], ['id'], null, null, false, true, null],
