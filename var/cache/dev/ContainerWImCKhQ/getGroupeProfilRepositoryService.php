 ...
 */
class getGroupeProfilRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GroupeProfilRepository' shared autowired service.
     *
     * @return \App\Repository\GroupeProfilRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GroupeProfilRepository.php';

        return $container->privates['App\\Repository\\GroupeProfilRepository'] = new \App\Repository\GroupeProfilRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
